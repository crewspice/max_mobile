                    ...
                    child: Text(
                      ...
                      style: GoogleFonts.permanentMarker(
                        ...
                        shadows: [
                          ...
                          // top-right (yellow → green transition feel)
                          const Shadow(
                          ...
                          // bottom-right (green → red transition feel)
                          const Shadow(
                          ...
                          // bottom-left (red → yellow transition feel)
                          const Shadow(
                          ...
                          // top-left (yellow → green return)
                          const Shadow(
                            color: Color(0x99FFFFFFB8),
                            offset: Offset(-2, -2),
                          ),

                          // soft inner glow to unify blend
                          const Shadow(
