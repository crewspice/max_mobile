...
class OuterOrbitParticles extends StatefulWidget {
  ...
  @override
  State<OuterOrbitParticles> createState() => _OuterOrbitParticlesState();
}

class _OuterOrbitParticlesState extends State<OuterOrbitParticles>
  ...
  Color _particleColor(
    ...
    final normalized = ((x - centerX) / maxRadius).clamp(-1.0, 1.0);
        ...
        builder: (context, child) {
          return LayoutBuilder(
            builder: (context, constraints) {
              ...
              final baseRadius = shortest * DeviceConfig.orbitRadius();
              ...
              for (final p in particles) {
                ...
                final targetVelocity = 0.12 + (1 - topBias) * 2.6;
