...
class _OuterOrbitParticlesState
  ...
  void initState() {
    ...
    double equilibriumWeight(double v) {
      // stronger contrast than linear but not full exponent explosion
    ...
    double pickAngle() {
      ...
      // importance sampling with controlled bias
      while (true) {
        ...
        // mix uniform + biased (THIS is the 60% fix)
    ...
    particles = List.generate(widget.particleCount, (_) {
      return _Particle(
        angle: pickAngle(),
        radius: 0.93 + _random.nextDouble() * 0.07,
        size: 2 + _random.nextDouble() * 20,
            ...
            builder: (context, constraints) {
              ...
              return Stack(
                children: particles.map((p) {
                  final orbitRadiusX = maxRadius * p.radius * 3.7;
                  final orbitRadiusY =
                      maxRadius * p.radius * 2.0;
